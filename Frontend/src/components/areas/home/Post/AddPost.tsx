...
export default function AddPost({ targetUserId }: AddPostProps): JSX.Element {
    ...
    <div className="flex justify-center w-full fade-in">
      <FormProvider {...methods}>
        <form
          ...
          className=" bg-white w-[650px] dark:bg-dark-second shadow-lg rounded-lg overflow-hidden mb-4 "
        >
          <header className="bg-blue-400 dark:bg-dark-third p-2 flex items-center space-x-4 border-b border-gray-200 dark:border-gray-600">
            <SelectInput
              defaultOption="Privacy"
              options={privacyOptions}
              registerName="privacy"
              className="bg-blue-100 dark:bg-dark-third text-blue-600 dark:text-dark-txt rounded-full cursor-pointer px-4 py-1 text-sm font-medium hover:bg-blue-300 dark:hover:bg-dark-third transition duration-300"
            />
          </header>
          ...
          <main className="p-12">
            <StringInput
              ...
              className="w-full rounded-lg p-3 text-sm bg-gray-100 dark:bg-dark-third border border-gray-300 dark:text-dark-txt placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-300 transition duration-200"
            />
          ...
          <div className="bg-blue-400 dark:bg-dark-third p-4 border-t border-gray-200 dark:border-gray-600 flex justify-end">
            <button
              type="submit"
