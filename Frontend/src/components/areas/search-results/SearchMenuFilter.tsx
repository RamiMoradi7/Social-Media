...
type SearchMenuFilterProps = {
    ...
    setSelectedFilter: (type: FilterTypes) => void;
};
            ...
            <div className="flex flex-wrap justify-center gap-2 md:gap-6">
                {Object.values(FilterTypes).map((type) => (
                    <label
                        key={type}
                        htmlFor={type}
                        className={`relative flex flex-col items-center justify-center w-16 h-16 p-1 border rounded-lg shadow-lg transition-transform duration-300 ease-in-out cursor-pointer transform hover:scale-105 ${selectedFilter === type
                    ...
                    >
                        ...
                        />
                        <svg
                            className={`w-12 h-12 mb-2 transition-transform duration-300 ease-in-out ${selectedFilter === type
                            ...
                            viewBox="0 0 24 24"
                        >
                            {type === FilterTypes.PEOPLE && (
                                <path d="M12 2a5 5 0 1 0 5 5 5 5 0 0 0-5-5zm0 8a3 3 0 1 1 3-3 3 3 0 0 1-3 3zm9 11v-1a7 7 0 0 0-7-7h-4a7 7 0 0 0-7 7v1h2v-1a5 5 0 0 1 5-5h4a5 5 0 0 1 5 5v1z" />
                            )}
                            {type === FilterTypes.POSTS && (
                                <>
                        ...
                        <span
                            className={`text-sm font-medium ${selectedFilter === type ? "text-blue-600" : "text-gray-700"
                                }`}
                        >
